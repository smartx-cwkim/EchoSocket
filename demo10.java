    ...
    public void orchestrator (DockerClient dockerClient) {
        ...
        while(true) {
            ...
            if(control.equals("input")) {
                ...
                tempxx = ct.bootStrap(dockerClient);
                ...
                System.out.println(inspectContainerResponse.getName());
                System.out.println(inspectContainerResponse.getConfig());
...
class Containerz extends com.github.dockerjava.api.model.Container{
    ...
    public String bootStrap(DockerClient dockerClient) {
