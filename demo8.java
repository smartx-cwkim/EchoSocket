        ...
        while(true) {
            ...
            if(control.equals("input")) {
                ...
                for (String key : containerList.keySet()) {
                    if(containerList.get(key).getStatus() != 1 && key.contains(temp)) {
                ...
                System.out.print("Enter the container name to want to check resource usage: ");
                String temp = scan.nextLine();
                ...
                for (String key : containerList.keySet()) {
                    if(containerList.get(key).getStatus() == 2 && key.contains(temp)) {
                    ...
                    } else if (containerList.get(key).getStatus() == 1) {
                        System.out.println("Container " + key + " not stopped. Stop it first");
                    } else {
                        System.out.println("Container " + key + " not exist");
                    }
                }
