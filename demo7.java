...
//    }
    ...
    public Image buildImage(DockerClient dockerClient) {
        ...
        return dockerClient.listImagesCmd().exec().get(0);
    }
}
...
class Container {
    ...
    public void createContainer(Data data, Image image) {
...
//                    .build();
        ...
        while(true) {
            ...
            if (tp == 1) {
                ...
                if (data.buildImage(dockerClient) == null) {
                    System.out.println("Docker images build first!!");
                    System.out.println("return to intro");
                    continue;
                }
